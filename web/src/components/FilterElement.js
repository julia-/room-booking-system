      ...
      <form className="form form--filter">
        ...
        <div className="form__group" onChange={(event) => onSetFloorParam(event.target.value)}>
          <div className="form_group">
            ...
            <label for="floor8" className="form__label form__label--inline form__label--filter">Level 8</label>
          </div>
          <div className="form_group">
            <input type="radio" value="13" name="floor-select" className="form__input--radio" checked={floorParam === '13' ? true : false}/>
            <label for="floor13" className="form__label form__label--inline form__label--filter">Level 13</label>
          </div>
          <div className="form_group">
            <input type="radio" value="all" name="floor-select" className="form__input--radio" checked={floorParam === 'all' ? true : false}/>
            <label for="all" className="form__label form__label--inline form__label--filter">All Levels</label>
          </div>
        </div>
        ...
        <div onChange={(event) => onToggleFeature(event.target.name)} >
          <div className="form__group">
            ...
            <label for="macLab" className="form__label form__label--inline form__label--filter">Mac Lab</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="pcLab" name="pcLab" className="form__input--checkbox" checked={filterParams[1].value} />
            <label for="pcLab" className="form__label form__label--inline form__label--filter">PC Lab</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="tv" name="tv" className="form__input--checkbox" checked={filterParams[2].value} />
            <label for="tv" className="form__label form__label--inline form__label--filter">TV</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="opWalls" name="opWalls" className="form__input--checkbox" checked={filterParams[3].value} />
            <label for="opWall" className="form__label form__label--inline form__label--filter">Operable Walls</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="projector" name="projector" className="form__input--checkbox" checked={filterParams[4].value} />
            <label for="projector" className="form__label form__label--inline form__label--filter">Projector</label>
          </div>
        </div>
        ...
        <div onChange={ (event) => onToggleCapacity(event.target.id)}>
          <div className="form_group">
            ...
            <label for="16seats" className="form__label form__label--inline form__label--filter">16 Seats</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="18seats" name="18seats" className="form__input--checkbox" checked={capacityParams[1].value} />
            <label for="18seats" className="form__label form__label--inline form__label--filter">18 Seats</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="20seats" name="20seats" className="form__input--checkbox" checked={capacityParams[2].value} />
            <label for="20seats" className="form__label form__label--inline form__label--filter">20 Seats</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="24seats" name="24seats" className="form__input--checkbox" checked={capacityParams[3].value} />
            <label for="24seats" className="form__label form__label--inline form__label--filter">24 Seats</label>
          </div>
          <div className="form_group">
            <input type="checkbox" id="40seats" name="40seats" className="form__input--checkbox" checked={capacityParams[4].value} />
            <label for="40seats" className="form__label form__label--inline form__label--filter">40 Seats</label>
          </div>
        </div>
        <h4 className="form__heading form__heading--filter">Availability</h4>
          <div onChange={(event) => onSetAvailabilityParam(event.target.value)} >
            <div className="form_group">
              ...
              <label for="fullyAvailable" className="form__label form__label--inline form__label--filter">Fully Available</label>
            </div>
            <div className="form_group">
              ...
              <label for="partialAvailable" className="form__label form__label--inline form__label--filter">Partially Available</label>
            </div>
            <div className="form_group">
              ...
              <label for="fullyBooked" className="form__label form__label--inline form__label--filter">Fully Booked</label>
            </div>
          </div>
      </form>
    </div>
